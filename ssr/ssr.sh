...
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/ssr"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${MasWayVPN}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${MasWayVPN}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${MasWayVPN}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${MasWayVPN}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${MasWayVPN}/renewssr.sh && chmod +x /usr/bin/renewssr
