...
# ==================================================
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/wireguard"
...
echo -e "${Info} Wireguard Script By MasWayVPN"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${MasWayVPN}/addwg.sh"
wget -O delwg "https://${MasWayVPN}/delwg.sh"
wget -O renewwg "https://${MasWayVPN}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
