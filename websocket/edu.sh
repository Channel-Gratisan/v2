...
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/websocket"

# Getting Proxy Template
wget -q -O /usr/local/bin/websocket https://${MasWayVPN}/websocket.py
...
# Getting Proxy Template
wget -q -O /usr/local/bin/ws-ovpn https://${MasWayVPN}/ws-ovpn.py
