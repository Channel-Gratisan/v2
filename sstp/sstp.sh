...
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/sstp"
...
wget -O /etc/accel-ppp.conf "https://${MasWayVPN}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${MasWayVPN}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${MasWayVPN}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${MasWayVPN}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${MasWayVPN}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
