#!/bin/bash
#shadowsocks-libev obfs install by MasWayVPN
...
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${MasWayVPN}/addss.sh"
wget -O delss "https://${MasWayVPN}/delss.sh"
wget -O cekss "https://${MasWayVPN}/cekss.sh"
wget -O renewss "https://${MasWayVPN}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
