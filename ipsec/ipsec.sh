...
# ==================================================
# Link Hosting Kalian
MasWayVPN="raw.githubusercontent.com/Channel-Gratisan/v2/main/ipsec"
...
wget -O /usr/bin/addl2tp https://${MasWayVPN}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${MasWayVPN}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${MasWayVPN}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${MasWayVPN}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${MasWayVPN}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${MasWayVPN}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
